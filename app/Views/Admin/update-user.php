                                ...
                                <div class="wg-box">
                                    ...
                                    <form action="?role=admin&act=update-post-user&id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="email" id="email" placeholder="Nhập email" name="email" class="form-control" value="<?= $user->email ?>">
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" id="phone" placeholder="Nhập số điện thoại" name="phone" class="form-control" value="<?= $user->phone ?>">
                                        </div>
